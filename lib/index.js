...
var initJasmine = function(files) {
  ...
  var editorIntegrationPath = path.dirname(require.resolve(path.resolve('../Tools/node_modules/editor-integration')));
  files.unshift(createPattern(editorIntegrationPath + '/editor-integration.js'));
  ...
  files.unshift(createPattern(__dirname + '/specFilter.js'));
